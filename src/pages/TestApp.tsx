...
import { mockTestQuestions, getUniqueSubjects, getUniqueTopics, getUniqueTestNumbers } from "@/utils/mockData";
import Header from "@/components/Header";
import Filter from "@/components/Filter";
import TestItem from "@/components/TestItem";

const TestApp = () => {
  const [testQuestions, setTestQuestions] = useState<TestQuestion[]>(mockTestQuestions);
